...
<body>
	<div class="board_wrap">
		...
		<form method = "get" action = "boardUpdateAction.jsp">
				...
				<tr>
					<td bgcolor=white>
						<table class = "table2">
							<tr>
								<td>제목</td>
								<td><input type = text name ="title" size=55 value="<%=rs.getString("title") %>"></td>
							</tr>

							<tr>
								<td>내용</td>
								<td><textarea name ="content" cols=55 rows=12 value="" ><%=rs.getString("contents") %></textarea></tr>
